<?php
$conn = new mysqli("localhost", "root", "", "datadiri");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["tambah"])) {
        ...
        if (!empty($nim) && !empty($nama) && !empty($alamat) && !empty($email)) {
            ...
            $query = "INSERT INTO biodataa (nim, nama, alamat, email) VALUES ('$nim', '$nama', '$alamat', '$email')";
            $result = $conn->query($query);
        ...
        $delete_query = "DELETE FROM biodata WHERE id=$id_to_delete";
